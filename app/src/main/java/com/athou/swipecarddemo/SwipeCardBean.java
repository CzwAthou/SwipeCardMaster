...
public class SwipeCardBean {
    ...
    public static List<SwipeCardBean> initDatas() {
        ...
        int i = 1;
        datas.add(new SwipeCardBean(i++, "http://imgs.ebrun.com/resources/2016_03/2016_03_25/201603259771458878793312_origin.jpg", "巴拉巴拉"));
        datas.add(new SwipeCardBean(i++, "http://p14.go007.com/2014_11_02_05/a03541088cce31b8_1.jpg", "巴拉巴拉"));
